...
All these differences in datums show up in maps. It's quite easy to come across a map using something that does not use WGS-84, and if you place a map overlay using that into an environment that assumes WGS-84 you'll see some entity locations that could have discrepencies hundreds of meters.

The earth is not smooth, and terrain can rise above or below the geoid, as with Mount Everest or the Dead Sea or the bottom of the Atlantic Ocean.
